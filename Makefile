...
LIBRARIES += `pkg-config --libs cudart-9.2 cufft-9.2 cudart-9.2 cublas-9.2 cufftw-9.2`
...
oct_acc.o:oct_acc.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

oct_acc_cpu.o:oct_acc_cpu.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

oct_acc: oct_acc.o oct_acc_cpu.o
...
clean:
	rm -f oct_acc oct_acc.o oct_acc_cpu.o
	rm -rf bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/oct_acc
